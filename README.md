...
This repository has been forked in order to make some changes to the module to better suit our needs. The original repository can be found [here](https://github.com/clouddrove/terraform-aws-labels).
This repository is not meant to be merged in any future back into the original repository.
